        ...
        <Card className={classes.root} variant="outlined">
            ...
            <CardContent className={classes.cardContent}>
                <Typography variant="h6" color="textSecondary"
                            gutterBottom> {`${props.username} has progress update`} </Typography>
            ...
            <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent>
                    ...
                    <div className={classes.replyField}>
                        <Input className={classes.replyTxt} placeholder="Write Comment..."
                               inputProps={{'aria-label': 'description'}} value={input_txt} onChange={getTxt}
                               onKeyDown={inputKeyDown}/>
                        <Button className={[classes.button, classes.replyBtn]} variant="contained" color="secondary"
                                onClick={sendReply}>
                            Reply
                            <SendIcon/>
                        </Button>
