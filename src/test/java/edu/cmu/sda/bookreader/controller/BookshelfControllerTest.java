...
//        assertEquals(responseBookshelf.getBody().getBookshelfUser(), bookshelf.getBookshelfUser());
...
////        List<AbstractBookshelf> allBookshelves = this.restTemplate.getForObject(getRootUrl() + "/api/recommended", List.class);
...
//        assertEquals(bookshelf.getBookshelfUser(), responseAnyBookshelf.getBookshelfUser());
