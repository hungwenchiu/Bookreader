...
public class CommentReplyService {
    ...
    public void saveReply(Comment comment) { repository.save(comment);}
    public List<Comment> getAllReplyById(String commentid) {return repository.findAllByEventid(commentid);}
